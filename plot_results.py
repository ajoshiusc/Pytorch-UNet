...
CONST = 100
image = imread('/home/ajoshi/projects/Pytorch-UNet/results/true_image.png')
image1 = imread('/home/ajoshi/projects/Pytorch-UNet/results/0p1.png')
image2 = imread('/home/ajoshi/projects/Pytorch-UNet/results/0p25.png')
image3 = imread('/home/ajoshi/projects/Pytorch-UNet/results/0p5.png')
image4 = imread('/home/ajoshi/projects/Pytorch-UNet/results/0p75.png')
image5 = imread('/home/ajoshi/projects/Pytorch-UNet/results/0p9.png')
...
image_edges[:,:,0] += np.uint8(CONST*edges3)
image_edges[:,:,1] += np.uint8(CONST*edges4)
#image_edges[:,:,2] += np.uint8(CONST*edges4)
#image_edges[:,:,1] += np.uint8(CONST*edges5)
image_edges[:,:,2] += np.uint8(CONST*edges5)
...
ax[2].set_title(r'$Pr(car)$', fontsize=10)

ax[1].imshow(image_edges, cmap='gray')
ax[1].set_title(r'R=Pr(car>.5), G=Pr(car>.25), B=Pr(car>.1)', fontsize=10)
